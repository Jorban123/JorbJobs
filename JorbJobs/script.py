import os,django
from JorbJobs.wsgi import *

from Jobs.models import Specialty

os.environ.setdefault ("DJANGO_SETTINGS_MODULE", "JorbJobs.settings") # project_name название проекта
django.setup()
...
for specialty in specialties:
    spec = Specialty.objects.create(code=specialty['code'], title=specialty['title'])
    spec.save()
